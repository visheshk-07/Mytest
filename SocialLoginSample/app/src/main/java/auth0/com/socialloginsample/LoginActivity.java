...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_btn = (ImageButton)findViewById(R.id.ibLogin);
        ...
        login_btn.setOnClickListener(
                ...
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(username.getText().toString().equals("vishesh")
                                && password.getText().toString().equals("password"))
                        {

                            Toast.makeText(LoginActivity.this,"User and password is correct",
                                    Toast.LENGTH_SHORT).show();
                                    Intent i = new Intent("auth0.com.socialloginsample.NavigationDrawer");
                                    startActivity(i);
                        }
